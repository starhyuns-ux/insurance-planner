        ...
        <div className="grid md:grid-cols-5 gap-12 lg:gap-16 items-center">
          <div className="md:col-span-2 relative mx-auto md:mx-0 w-64 h-64 md:w-full md:h-auto md:aspect-[4/5] rounded-[2rem] overflow-hidden border border-gray-700 bg-gray-800 shadow-2xl">
            <div className="absolute inset-0 flex flex-col items-center justify-center p-6 text-center z-10">
              ...
              <div className="text-2xl font-extrabold text-white">상위 1% 전문가 배정</div>
            </div>
            ...
            <div className="absolute bottom-0 inset-x-0 bg-gradient-to-t from-gray-900 to-transparent h-2/3"></div>
            <div className="absolute top-0 inset-x-0 bg-gradient-to-b from-gray-900 to-transparent h-1/4"></div>
          ...
          <div className="md:col-span-3">
            <h2 className="text-3xl md:text-4xl lg:text-[2.5rem] font-extrabold mb-8 tracking-tight leading-tight">
              실적만을 쫓는 영업은<br /> <span className="text-primary-400">하지 않겠습니다.</span>
            </h2>
