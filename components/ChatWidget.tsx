...
export default function ChatWidget() {
  ...
  return (
    <>
      ...
      <button
        onClick={() => setOpen(o => !o)}
        className="fixed bottom-44 lg:bottom-28 right-6 z-50 w-14 h-14 bg-primary-600 text-white rounded-full shadow-2xl hover:bg-primary-700 transition-all hover:scale-105 flex items-center justify-center"
        aria-label="상담 채팅"
      >
        {open ? (
