...
export default async function PlannerPremiumCalcPage({ params }: { params: { id: string } }) {
    ...
    <main className="min-h-screen flex flex-col bg-gray-50">
      ...
      <div className="flex-1 container mx-auto px-4 py-8 max-w-4xl">
        ...
        <div className="text-center mb-10">
          ...
          <p className="text-sm font-bold text-gray-400">{planner.name} 설계사가 제공하는 스마트 분석 도구</p>
        </div>
